/**
 *  @file    CPT/improc/min_cv_auto_margin.hpp
...
/**
 *  @brief      @copybrief CPT/improc/min_cv_auto_margin.hpp    
...
struct MinCVAutoMargin
{
    ...
    auto operator()( 
        ...
        , int32_t windows_width
        , int32_t windows_height 
    )
    {
        ...
        for ( auto& t: tiles )
        {
            cpt::utility::throw_if( t.width < windows_width );
            cpt::utility::throw_if( t.height < windows_height );

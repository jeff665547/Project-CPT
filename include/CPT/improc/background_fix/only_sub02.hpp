/**
 *  @file       CPT/improc/background_fix/only_sub01.hpp
...
/**
 *  @brief      @copybrief CPT/improc/background_fix/only_sub02.hpp
 */
constexpr struct PartialProbeGridSubBase02 : public SegmentMean
{
    /**
